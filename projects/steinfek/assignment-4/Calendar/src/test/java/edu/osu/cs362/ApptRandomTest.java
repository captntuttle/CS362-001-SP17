				...
				Random random = new Random(randomseed);
					...
					String methodName = ApptRandomTest.RandomSelectMethod(random);
					   if (methodName.equals("setTitle")){
						...
						if (methodName.equals("isValid")){
					   		...
					   		testAppt.setStartMonth(value.nextInt(12) + 13);
					   		assertFalse(testAppt.getValid());
					   		testAppt = appt;
					   		testAppt.setStartMonth(value.nextInt(12) - 13);
					   		assertFalse(testAppt.getValid());
					   		testAppt.setStartDay(value.nextInt(31) + 32);
					   		assertFalse(testAppt.getValid());
					   		testAppt.setStartDay(value.nextInt(31) - 32);
					   		assertFalse(testAppt.getValid());
					   		testAppt.setStartMinute(value.nextInt(60) + 61);
					   		assertFalse(testAppt.getValid());
					   		testAppt.setStartMinute(value.nextInt(60) - 61);
					   		assertFalse(testAppt.getValid());
					   		testAppt.setStartHour(value.nextInt(23) + 24);
					   		assertFalse(testAppt.getValid());
					   		testAppt.setStartHour(value.nextInt(23) - 24);
					   		assertFalse(testAppt.getValid());
				 ...
				 elapsed = (Calendar.getInstance().getTimeInMillis() - startTime);
			        if((iteration%10000)==0 && iteration!=0 )
			              System.out.print("elapsed time: "+ elapsed + " of "+TestTimeout + "\r");
